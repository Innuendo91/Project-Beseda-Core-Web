...
Серверная часть Project Beseda: веб-интерфейс, API, чат, стримы, голосовые комнаты и интеграция с desktop-клиентом.

## Основной функционал

- веб-клиент на Vue SPA;
- просмотр стримов через WebRTC/WHEP;
- публикация стримов через SRT и браузерный стрим;
- общий чат, комнаты чата, личные сообщения;
