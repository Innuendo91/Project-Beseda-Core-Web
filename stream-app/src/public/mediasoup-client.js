...
var require_h264_profile_level_id = __commonJS({
  "node_modules/h264-profile-level-id/index.js"(exports) {
    ...
    var warn = require_browser2()("h264-profile-level-id:WARN");
    ...
    var ProfileHigh = 5;
    var ProfilePredictiveHigh444 = 6;
    ...
    var ProfilePatterns = [
      ...
      new ProfilePattern(244, new BitPattern("00000000"), ProfilePredictiveHigh444)
    ];
...
var _mod = require_index();
export default _mod;
export var Device = _mod.Device;
export var detectDevice = _mod.detectDevice;
export var types = _mod.types;
export var version = _mod.version;
export var debug = _mod.debug;
export var parseScalabilityMode = _mod.parseScalabilityMode;
